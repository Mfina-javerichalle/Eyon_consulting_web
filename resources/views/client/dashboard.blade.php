...
<header class="ec-topbar">
    ...
    <div class="topbar-user">
        {{-- Avatar mis à jour avec storage/ --}}
    ...
    <main class="client-main">
        ...
        <div id="section-dashboard" class="client-section">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-3 col-sm-6" data-aos="fade-up" data-aos-delay="0">
                    <div class="stat-card">
                        ...
                        <div><div class="stat-number">{{ $stats['total'] }}</div><div class="stat-label">Total dossiers</div></div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6" data-aos="fade-up" data-aos-delay="80">
                    <div class="stat-card">
                        ...
                        <div><div class="stat-number">{{ $stats['en_cours'] + $stats['attente'] }}</div><div class="stat-label">En cours</div></div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6" data-aos="fade-up" data-aos-delay="160">
                    <div class="stat-card">
                        ...
                        <div><div class="stat-number">{{ $stats['valides'] }}</div><div class="stat-label">Validés</div></div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6" data-aos="fade-up" data-aos-delay="240">
                    <div class="stat-card">
                        ...
                        <div><div class="stat-number">{{ $stats['refuses'] }}</div><div class="stat-label">Refusés</div></div>
                    </div>
                </div>
            </div>
                ...
                <div class="ec-card-body p-0">
                    @if($dossiers->isNotEmpty())
                        <div class="table-responsive">
                            <table class="dossier-table">
                                <thead><tr><th>#</th><th>Service</th><th>Pays</th><th>Statut</th><th>Date</th></tr></thead>
                                <tbody>
                                    @foreach($dossiers->take(5) as $dossier)
                                        <tr>
                                            <td style="font-weight:700; color:var(--muted);">#{{ $dossier->id }}</td>
                                            ...
                                            <td style="color:var(--muted); font-size:0.85rem;">{{ $dossier->created_at->format('d/m/Y') }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    @else
                        <div class="text-center py-5" style="color:var(--muted);">
                            ...
                            <a href="#" onclick="showSection('dossiers', document.getElementById('link-dossiers')); return false;" class="btn-form-submit mt-2">
            ...
            <div class="ec-alert ec-alert-info mt-4" data-aos="fade-up">
                ...
                <div><strong>Nouveau ici ?</strong> Commencez par <strong>choisir un service</strong> dans l'onglet "Mes dossiers" pour créer votre premier dossier de visa.</div>
            </div>
        </div>
            ...
            <div class="ec-card mb-4" data-aos="fade-up">
                ...
                <div class="ec-card-body">
                    <div class="ec-alert ec-alert-info">
                        ...
                        <div>La création de dossier sera disponible très bientôt !</div>
                    </div>
                </div>
            </div>
                ...
                <div class="ec-card-body p-0">
                    @if($dossiers->isNotEmpty())
                        <div class="table-responsive">
                            <table class="dossier-table">
                                <thead>
                                    <tr><th>#ID</th><th>Service</th><th>Pays</th><th>Statut</th><th>Créé le</th><th>Actions</th></tr>
                                </thead>
                                <tbody>
                                    @foreach($dossiers as $dossier)
                                        <tr>
                                            ...
                                            <td style="color:var(--muted); font-size:0.85rem;">{{ $dossier->created_at->format('d/m/Y') }}</td>
                                            <td>
                                                <span class="btn-table btn-table-primary">
...
<script>
    ...
    /* Ouvrir automatiquement l'onglet profil si erreur */
